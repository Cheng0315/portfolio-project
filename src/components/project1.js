        ...
        <div className='row'>
          <Fade left delay={600} distance={'60px'}>
            <div className='project-img col-lg-5 offset-lg-1'>
              <a href='https://ichiban-fresno.herokuapp.com/' target="_blank" rel="noopener noreferrer"><img alt='ichiban' src='https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-9/11407135_869083649829783_6563221059322769096_n.jpg?_nc_cat=107&_nc_ht=scontent-sjc3-1.xx&oh=a6c3d927876283e61646aaac5bde9482&oe=5D5F2F1C'/></a>
            </div>
          </Fade>
